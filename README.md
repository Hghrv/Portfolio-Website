...
For pull requests you can clone the repo and try the projects yourself by cloning the git repo and running the makefile with the following commands on Linux:

git clone <repo-link>

Makefile

Note: If you do not have Git or Make installed, you might need to install them with the Pip installer or another such package installer.

Enjoy my portfolio website ! 
